...
const AVAILABLE_TOAST_ID = 'deepclaw-update-available';
const DOWNLOADED_TOAST_ID = 'deepclaw-update-downloaded';
 ...
 * Sonner toast (`UpdateToast`) that follows the active DeepClaw theme.
 */
