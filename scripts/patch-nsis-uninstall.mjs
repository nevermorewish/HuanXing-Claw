 ...
 * shows a misleading "app cannot be closed" dialog even when DeepClaw is not running.
 */
...
const PATCH_MARKER = 'DeepClaw-patched: skip legacy uninstaller';

const SKIP_LEGACY_UNINSTALLER = [
  '  ; DeepClaw-patched: skip legacy uninstaller on upgrades.',
