...
describe('installer.nsh running-app guard', () => {
  it('fails closed when DeepClaw.exe remains alive during overwrite install', () => {
    ...
    expect(guard).toContain('DeepClaw is still running and cannot be replaced safely');
