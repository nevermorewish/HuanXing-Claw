 ...
 * DeepClaw's UI keeps the Thinking… indicator / Execution Graph "active" or
 * tears them down.
 *
 * In production, DeepClaw consumes already-normalized messages from the OpenClaw
 ...
 * provider protocols DeepClaw may encounter.
 */
